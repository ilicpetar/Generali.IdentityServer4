using Generali.WebAPI.Client.Models;
using Generali.WebAPI.Client.Services;
...
namespace Generali.WebAPI.Client.Controllers
{
    ...
    public class WeatherController : ControllerBase
    {
        ...
        public async Task<IEnumerable<WeatherForecast>> Get()
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var result = await client.GetAsync("https://localhost:44325/weatherforecast");
